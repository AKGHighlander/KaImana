...
//define  _LED_ORDER_FULL  true
  ...
  #define  LED_P1_B    21  
  #define  LED_HOME    28
  #define  LED_HOME_B  29
  #define  LED_GUIDE   30
  #define  LED_GUIDE_B 31
  #define  LED_SELECT  14
  #define  LED_SELECT_B 15
  #define  LED_BACK    32
  #define  LED_BACK_B  33
  #define  LED_START   12
  #define  LED_START_B 13
...
//
#define  COMBO_PATTERN_1A    ATTACK_RIGHT + ATTACK_DOWN + ATTACK_P2, ATTACK_NONE, ATTACK_RIGHT
#define  COMBO_PATTERN_1B    ATTACK_LEFT + ATTACK_DOWN + ATTACK_P2 + ATTACK_P3, ATTACK_NONE, ATTACK_LEFT + ATTACK_P3
#define  COMBO_PATTERN_2A    ATTACK_RIGHT + ATTACK_LEFT, ATTACK_DOWN + ATTACK_RIGHT, ATTACK_RIGHT, ATTACK_RIGHT + ATTACK_LEFT, ATTACK_DOWN + ATTACK_RIGHT, ATTACK_RIGHT
#define  COMBO_PATTERN_2B    ATTACK_LEFT + ATTACK_RIGHT, ATTACK_DOWN + ATTACK_LEFT + ATTACK_P3, ATTACK_LEFT + ATTACK_P3, ATTACK_LEFT + ATTACK_RIGHT + ATTACK_P3, ATTACK_DOWN + ATTACK_LEFT + ATTACK_P3, ATTACK_LEFT
#define  COMBO_PATTERN_3A    ATTACK_DOWN + ATTACK_RIGHT + ATTACK_K2, ATTACK_NONE, ATTACK_RIGHT
#define  COMBO_PATTERN_3B    ATTACK_DOWN + ATTACK_LEFT + ATTACK_K2 + ATTACK_P3, ATTACK_NONE, ATTACK_LEFT + ATTACK_P3
#define  COMBO_PATTERN_4A    ATTACK_RIGHT + ATTACK_K2, ATTACK_NONE, ATTACK_RIGHT
#define  COMBO_PATTERN_4B    ATTACK_LEFT + ATTACK_K2 + ATTACK_P3, ATTACK_NONE, ATTACK_LEFT + ATTACK_P3
#define  COMBO_PATTERN_5A    ATTACK_DOWN + ATTACK_LEFT + ATTACK_P2 + ATTACK_P3, ATTACK_DOWN, ATTACK_NONE, ATTACK_LEFT + ATTACK_P3
#define  COMBO_PATTERN_5B    ATTACK_DOWN + ATTACK_RIGHT + ATTACK_P2, ATTACK_DOWN, ATTACK_NONE, ATTACK_RIGHT
#define  COMBO_PATTERN_6A    ATTACK_DOWN + ATTACK_RIGHT + ATTACK_P1, ATTACK_NONE, ATTACK_RIGHT
#define  COMBO_PATTERN_6B    ATTACK_DOWN + ATTACK_LEFT + ATTACK_P1 + ATTACK_P3, ATTACK_NONE, ATTACK_LEFT + ATTACK_P3
