...
#define  COMBO_PATTERN_1B    ATTACK_LEFT + ATTACK_DOWN + ATTACK_P2, ATTACK_NONE, ATTACK_LEFT
...
#define  COMBO_PATTERN_2B    ATTACK_LEFT + ATTACK_RIGHT, ATTACK_DOWN + ATTACK_LEFT, ATTACK_LEFT, ATTACK_LEFT + ATTACK_RIGHT, ATTACK_DOWN + ATTACK_LEFT, ATTACK_LEFT
...
#define  COMBO_PATTERN_4A    ATTACK_DOWN + ATTACK_RIGHT + ATTACK_P2, ATTACK_DOWN, ATTACK_NONE, ATTACK_RIGHT
#define  COMBO_PATTERN_4B    ATTACK_DOWN + ATTACK_LEFT + ATTACK_P2, ATTACK_DOWN, ATTACK_NONE, ATTACK_LEFT
#define  COMBO_PATTERN_5A    ATTACK_DOWN + ATTACK_RIGHT + ATTACK_K2, ATTACK_NONE, ATTACK_RIGHT
#define  COMBO_PATTERN_5B    ATTACK_DOWN + ATTACK_LEFT + ATTACK_K2, ATTACK_NONE, ATTACK_LEFT
#define  COMBO_PATTERN_6A    ATTACK_DOWN + ATTACK_RIGHT + ATTACK_P1, ATTACK_NONE, ATTACK_RIGHT
#define  COMBO_PATTERN_6B    ATTACK_DOWN + ATTACK_LEFT + ATTACK_P1, ATTACK_NONE, ATTACK_LEFT
