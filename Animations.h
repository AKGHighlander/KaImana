...
void animation_combo_1(void);    // PEWGF
void animation_combo_2(void);    // BDC
void animation_combo_3(void);    // JFSR
void animation_combo_4(void);    // f,f+4
void animation_combo_5(void);    // EWGF
void animation_combo_6(void);    // OTGF
